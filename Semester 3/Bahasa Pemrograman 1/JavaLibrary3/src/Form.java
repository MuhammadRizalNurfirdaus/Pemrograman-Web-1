...
public class Form extends javax.swing.JFrame {
    ...
    String prodi = (String) jComboBox1.getSelectedItem();
    String alamat = jTextArea1.getText();

    String sql = "INSERT INTO mhs (nim, nama, jk, prodi, alamat) VALUES ('" +
    ...
    try {
        ...
        load_data(); // Memuat ulang tabel setelah menyimpan
    } catch (Exception e) {
    ...
    private void load_data(){
        ...
        String sql = "SELECT mhs.nim, mhs.nama, mhs.jk, mhs.prodi, mhs.alamat";
